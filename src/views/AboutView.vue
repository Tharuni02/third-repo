...
<div class="card mt-5" style="max-width: 15rem">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Click the button to get the course details.</p>
   <b-row> <b-col cols="3"><a href="#" class="btn btn-lg" style="background-color:#4B0082; color:white;">Click..</a>
   </b-col></b-row>
    </div>
  </div>
 </b-col><b-col> 
